...
# Class to keep only last 5 best checkpoints
...
def get_callbacks(model, val_data, save_dir, save_every_epochs=5, early_stopping_patience=10, log_images_every=5, num_images_to_log=4):
